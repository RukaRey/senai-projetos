...
<body>
    <div>
        <form action="<?php htmlspecialchars($_SERVER['PHP_SELF']); ?>" method='post'>
            ...
            <label for="">Vínculo com instituição</label><br><br>
            ...
            <label for="inativo">Ex-aluno</label><br> -->

            <input type="submit" id='send' name='send' value="emit docs">
        </form>
    </div>
...
<?php
    if (isset($_POST['send'])){
        header("Location: php/form_p1.php");
